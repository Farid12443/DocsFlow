...
<body class="grid grid-cols-6">
    <aside class="w-full h-screen bg-[#FFFFFF] flex flex-col border-r border-black col-span-1">
        <nav class="p-6 space-y-4">
            ...
            <a href="#"
                class="flex items-center justify-between px-4 py-3 rounded-lg bg-green-500 text-white shadow-md">
                <span>Dashboard</span>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                    stroke="currentColor" class="size-6">
                    <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-content ml-8 mt-2 space-y-2 text-sm">
                    <a href="#" class="block px-3 py-2 rounded hover:bg-green-50 hover:text-green-600 transition">Semua
                        Dokumen</a>
                    <a href="#"
                        class="block px-3 py-2 rounded hover:bg-green-50 hover:text-green-600 transition">Dokumen
                        Aktif</a>
                    <a href="#"
                        class="block px-3 py-2 rounded hover:bg-green-50 hover:text-green-600 transition">Arsip</a>
